...
export async function POST(request) {
 ...
 const embed = {
  title: "📩 New message from sakshyambaral.com.np",
 ...
 try {
  const response = await fetch(`${process.env.DISCORD_WEBHOOK_URL}?wait=true`, {
   ...
   body: JSON.stringify({
    username: "sakshyambaral.com.np",
    avatar_url: "https://cdn.discordapp.com/attachments/1023329979410423919/1148236420813705307/cb270694ea649c1f6f7aa3f674f3c208.jpg",
    embeds: [embed],
   }),
  });
