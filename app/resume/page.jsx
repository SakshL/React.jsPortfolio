...
export default function Resume() {
 return (
  <div className="mx-auto mb-16 flex max-w-7xl flex-col items-start justify-center">
   {/* Hero Section */}
   <div className="relative mb-12 w-full overflow-hidden rounded-2xl bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-8 text-white">
    ...
    <div className="relative z-10">
     <h1 className="mb-4 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-5xl font-bold text-transparent">SAKSHYAM BARAL</h1>
     <p className="mb-4 text-2xl font-light text-blue-100">Creative Tech Enthusiast & Full-Stack Developer</p>
     <p className="mb-6 text-lg text-blue-200">4 years of experience crafting digital experiences</p>
     ...
     <div className="flex flex-wrap gap-3">
      <Link href="https://github.com/SakshL" target="_blank" className="group flex items-center gap-2 rounded-lg bg-gray-900/50 px-4 py-2 backdrop-blur-sm transition-all hover:scale-105 hover:bg-gray-900/70">
      ...
      <Link href="#" target="_blank" className="group flex items-center gap-2 rounded-lg bg-blue-600/50 px-4 py-2 backdrop-blur-sm transition-all hover:scale-105 hover:bg-blue-600/70">
       <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <Link href="/" className="group flex items-center gap-2 rounded-lg bg-purple-600/50 px-4 py-2 backdrop-blur-sm transition-all hover:scale-105 hover:bg-purple-600/70">
       <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
   ...
   <div className="mb-8 w-full">
    <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-50 to-blue-50 p-8 shadow-xl transition-all hover:shadow-2xl dark:from-gray-800 dark:to-gray-900">
     ...
     <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
      Creative tech enthusiast with <span className="font-semibold text-purple-600">4 years of experience</span> in web development and multimedia production. Built and maintained a personal portfolio site, led a video editing team, and used <span className="font-semibold text-blue-600">Python and Node.js</span> to deliver engaging projects. Skilled in combining technical know-how with creative strategy to drive impactful results.
     </p>
    </div>
   </div>
   ...
   <div className="mb-8 w-full">
    ...
    <div className="grid gap-6 md:grid-cols-2">
     {[
      ...
      <div key={index} className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all hover:-translate-y-1 hover:shadow-2xl dark:bg-gray-800">
       ...
       <div className="relative">
        <div className="mb-4 flex items-start gap-4">
         ...
         <div className="flex-1">
          ...
          <span className="mt-1 inline-block rounded-full bg-cyan-100 px-3 py-1 text-xs font-medium text-cyan-800 dark:bg-cyan-900 dark:text-cyan-200">{internship.period}</span>
         </div>
        </div>
        <ul className="space-y-2">
     ...
     <div className="grid gap-3">
      {[
       ...
       <div key={index} className="flex items-center justify-between rounded-lg bg-gray-50 p-3 dark:bg-gray-700">
        ...
        <span className={`rounded-full bg-${course.color}-100 px-2 py-1 text-xs font-medium text-${course.color}-800 dark:bg-${course.color}-900 dark:text-${course.color}-200`}>{course.org}</span>
       </div>
      ))}
     </div>
    </div>
   ...
   <div className="mt-12 w-full text-center">
    <div className="rounded-3xl bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 p-8 text-white">
     ...
     <div className="flex flex-wrap justify-center gap-4">
      <Link href="/resume-sakshyam.pdf" target="_blank" className="group inline-flex items-center rounded-xl bg-white px-6 py-3 font-semibold text-purple-600 transition-all hover:scale-105 hover:bg-gray-100 hover:shadow-lg">
